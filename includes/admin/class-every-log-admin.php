...
class EFWAdmin {
    ...
    { ?>
        <h2 class="el_api_title"><?php _e('Settings', EFW_NAME); ?></h2>
    <?php
    }
    ...
    ?>
        <div class="el_api_card">
            <div class="el_api_row">
                <div class="el_api_col-md-8">
                    <div class="left-sec">
                        <h2><?php esc_attr_e('Product Out of Stock' , EFW_NAME ); ?></h2>
                        <div class="register-content">
                            <div class="el_api_custom_switch">
    ...
    public function efw_out_of_stock( $availability, $product_to_check )
    {
    ...
    public function add_hooks()
    {
        ...
        add_filter( 'woocommerce_get_availability', array( $this , 'efw_out_of_stock' ), 1, 2 );
